...
#define PMW3360_REG_SHUTTER_HIGHER 0x07
#define PMW3360_REG_SHUTTER_LOWER 0x08
#define PMW3360_REG_PIX_MAX 0x09
#define PMW3360_REG_PIX_AVG 0x0A
#define PMW3360_REG_PIX_MIN 0x0B

#define PMW3360_REG_CRC0 0x0C
#define PMW3360_REG_CRC1 0x0D
#define PMW3360_REG_CRC2 0x0E
#define PMW3360_REG_CRC3 0x0F
#define PMW3360_REG_SELF_TEST 0x10

#define PMW3360_REG_PERFORMANCE 0x11
#define PMW3360_REG_MOTION_BURST 0x12

#define PMW3360_REG_RUN_DOWNSHIFT 0x1B
#define PMW3360_REG_REST1_PERIOD 0x1C
#define PMW3360_REG_REST1_DOWNSHIFT 0x1D
#define PMW3360_REG_REST2_PERIOD 0x1E
#define PMW3360_REG_REST2_DOWNSHIFT 0x1F
#define PMW3360_REG_REST3_PERIOD 0x20
#define PMW3360_REG_OBSERVATION 0x2D

#define PMW3360_REG_PIXEL_GRAB 0x35
#define PMW3360_REG_FRAME_GRAB 0x36

#define PMW3360_REG_POWER_UP_RESET 0x3A
#define PMW3360_REG_SHUTDOWN 0x3B

#define PMW3360_REG_SPI_CLK_ON_REQ 0x41
#define PMW3360_REG_RES_STEP 0x85

#define PMW3360_REG_NOT_REV_ID 0x3E
#define PMW3360_REG_NOT_PROD_ID 0x3F

#define PMW3360_REG_PRBS_TEST_CTL 0x47
#define PMW3360_REG_SPI_PAGE0 0x7F
#define PMW3360_REG_VCSEL_CTL 0x9E
#define PMW3360_REG_LSR_CONTROL 0x9F
#define PMW3360_REG_SPI_PAGE1 0xFF

/* Sensor identification values */
#define PMW3360_PRODUCT_ID 0x3E

/* Power-up register commands */
#define PMW3360_POWERUP_CMD_RESET 0x5A
#define PMW3360_POWERUP_CMD_WAKEUP 0x96

/* spi clock enable/disable commands */
#define PMW3360_SPI_CLOCK_CMD_ENABLE 0xBA
#define PMW3360_SPI_CLOCK_CMD_DISABLE 0xB5

/* Max register count readable in a single motion burst */
#define PMW3360_MAX_BURST_SIZE 10

/* Register count used for reading a single motion burst */
#define PMW3360_BURST_SIZE 7

/* Position in the motion registers */
#define PMW3360_X_L_POS 1
#define PMW3360_Y_L_POS 2
#define PMW3360_XY_H_POS 3
#define PMW3360_SHUTTER_H_POS 5
#define PMW3360_SHUTTER_L_POS 6

/* cpi/resolution range */
#define PMW3360_MAX_CPI 3200
#define PMW3360_MIN_CPI 200
